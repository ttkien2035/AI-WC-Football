...
const DICT: Record<string, { vi: string; en: string }> = {
  ...
  "match.sim_flip": { vi: "Kết quả lật so với H1", en: "Result flips vs HT" },
  "match.volatile": { vi: "Trận biến động cao — {p} khả năng kết quả lật so với hiệp 1; cửa dự đoán kém chắc chắn hơn con số.", en: "High-volatility fixture — {p} chance the result flips vs half-time; treat the pick more cautiously than the number suggests." },
  ...
  "ana.style_note": { vi: "Lối chơi/chiến thuật ĐÃ vào dự đoán qua 3 kênh có chặn (Tài/Xỉu, W/D/L, mô phỏng phút) — tag được xác nhận/bác bằng số liệu thật trong giải và chấm điểm A/B ở Pipeline. Thẻ đỏ & vắng trụ cột tính theo Elo.", en: "Style/tactics now FEED the prediction via 3 bounded channels (O/U, W/D/L, minute sim) — tags confirmed/vetoed by observed tournament stats and A/B-graded in the Pipeline. Red cards & absences are Elo penalties." },
  "ana.observed": { vi: "Quan sát trong giải ({n} trận): kiểm soát {poss}% · {shots} cú sút/trận · xG {xgf}–{xga}", en: "Observed in-tournament ({n} games): {poss}% possession · {shots} shots/game · xG {xgf}–{xga}" },
  // style tags
  ...
  "pl.sc_style_sup": { vi: "Lối chơi → W/D/L", en: "Style → W/D/L" },
  "pl.corners_sc": { vi: "Hiệu chỉnh Tài/Xỉu phạt góc (dự đoán trước trận vs thực tế)", en: "Corners O/U calibration (pre-match vs actual)" },
  ...
  "pl.st_actual": { vi: "Thực tế", en: "Actual" },
  "pl.st_ht_flip": { vi: "Kết quả lật so với H1", en: "Result flips vs HT" },
  "pl.st_late_goal_80plus": { vi: "Có bàn sau phút 80", en: "Goal after 80'" },
  "pl.st_home_comeback": { vi: "Chủ nhà ngược dòng thắng", en: "Home comeback win" },
  "pl.st_clean_sheet_home": { vi: "Chủ nhà sạch lưới", en: "Home clean sheet" },
  "pl.st_clean_sheet_away": { vi: "Khách sạch lưới", en: "Away clean sheet" },
